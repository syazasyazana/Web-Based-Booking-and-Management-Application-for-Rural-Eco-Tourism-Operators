...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO payments (name, orderDate, companyName, address, postalCode, email, branch, totalPrice) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = mysqli_prepare($conn, $sql);

        if ($stmt) {
            mysqli_stmt_bind_param($stmt, "sssssssd", $name, $orderDate, $companyName, $address, $postalCode, $email, $branch, $totalPrice);
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                echo "<p><strong>Payment Amount:</strong> $totalPrice</p>";
